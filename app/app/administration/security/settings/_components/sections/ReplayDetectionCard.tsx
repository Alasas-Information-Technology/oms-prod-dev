    ...
    <Card className="rounded-2xl border-border/70 bg-card/70 backdrop-blur-xs shadow-xs">
      ...
      <CardContent className="pt-6 space-y-6">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row items-center justify-between rounded-xl border border-border/70 bg-background/50 p-4 transition-all hover:bg-background/80">
        ...
        {isDetectionEnabled ? (
          <div className="space-y-4 rounded-xl border border-red-200 dark:border-red-900/40 bg-red-50/40 dark:bg-red-950/20 p-4">
          ...
          <div className="p-4 rounded-xl border border-border/70 bg-muted/30 text-xs text-muted-foreground flex items-center gap-2">
