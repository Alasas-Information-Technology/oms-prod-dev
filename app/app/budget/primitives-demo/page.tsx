...
export default function BudgetPrimitivesDemoPage() {
  ...
  return (
    <div className="p-6 space-y-8 animate-in fade-in-50 duration-200">
      {/* Header Banner */}
      <div className="relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-b from-primary/10 via-card to-card p-6 md:p-8 shadow-xs">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <Button asChild variant="outline" size="sm" className="rounded-xl text-xs gap-1.5 h-9">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="rounded-2xl border-border/70 bg-card/70 backdrop-blur-xs p-5 space-y-2">
      ...
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 p-2 rounded-xl bg-card border border-border/80 shadow-2xs">
        ...
        {simulateMismatch && (
          <div className="p-4 rounded-xl border border-amber-300 bg-amber-50/80 dark:border-amber-900/60 dark:bg-amber-950/30 text-xs text-amber-900 dark:text-amber-200 flex items-center justify-between gap-3">
            <span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="rounded-2xl border-border/70 bg-card/70 backdrop-blur-xs">
