...
import { Landmark, CheckCircle2, AlertTriangle, XCircle, ArrowUpRight, ArrowDownRight, Minus } from "lucide-react";
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="tabular-nums font-semibold text-foreground">
              AED {formatAmount(currentReservation)}
            </span>
          </div>
