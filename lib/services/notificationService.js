...
export const notificationService = {
  ...
  async dispatchRoleNotification(targetRoleName, targetDepartmentId, requisitionId, title, message) {
    ...
    // 2. Apply department isolation for non-global administrative roles
    ...
    if (fetchError) {
      console.error(`Error fetching recipients for ${targetRoleName}:`, fetchError);
      return;
    }
    ...
    if (insertError) console.error('Bulk notification dispatch failed:', insertError);
  }
};
