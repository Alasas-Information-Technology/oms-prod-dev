...
export const requisitionService = {
    ...
    if (currentStageId === 5) {
      ...
      if (rd) {
        await notificationService.createNotification({
          ...
          message: `Your requisition ${rd.req_number} has been successfully fulfilled and the candidate is active.`
        });
      }
        ...
        switch (nextStageId) {
          case 2:
            await notificationService.dispatchRoleNotification(
              ...
              `Requisition ${requisition.req_number} requires HR approval to proceed to Vendor Submission.`
            );
            break;
          case 3:
            await notificationService.dispatchRoleNotification(
              ...
              `Requisition ${requisition.req_number} has been approved by HR and is ready for vendor distribution.`
            );
            break;
          case 4:
            await notificationService.dispatchRoleNotification(
              ...
              `Submissions for ${requisition.req_number} have closed. Please review blind candidates and orchestrate interviews.`
            );
            break;
          case 5:
            await notificationService.dispatchRoleNotification(
              ...
              `A candidate has been qualified for ${requisition.req_number}. Please complete the digital onboarding checklist.`
            );
            break;
        }
      }
  ...
  async terminateRequisition(reqId, actorId, reason) {
    ...
    await notificationService.createNotification({
      ...
      message: `Your requisition ${requisition.req_number} has been rejected and returned to you. Please check the audit logs for comments.`
    });
