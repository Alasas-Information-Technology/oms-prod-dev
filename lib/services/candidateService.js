...
export const candidateService = {
  ...
  async getCandidatesForRequisition(requisitionId) {
  ...
  /**
   * Update multiple candidate rankings and promoted statuses.
   * @param {Record<string, string | null>} rankings - Map of candidateId -> ranking (P1, P2, P3, Rejected, or null)
   * @param {boolean} finalize - If true, promotes candidates to QUALIFIED/REJECTED.
   */
