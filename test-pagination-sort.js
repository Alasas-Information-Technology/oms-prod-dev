...
(async () => {
  await testUrl('https://oms-api.alasasit.com/api/v1/organization/units?page=1&pageSize=100&sortBy=createdAt&sortOrder=DESC');
  await testUrl('https://oms-api.alasasit.com/api/v1/organization/units?page=1&pageSize=100&orderBy=createdAt');
  await testUrl('https://oms-api.alasasit.com/api/v1/organization/units?page=1&pageSize=100&sort=createdAt');
  await testUrl('https://oms-api.alasasit.com/api/v1/organization/units?page=1&pageSize=100&sortField=createdAt&sortOrder=DESC');
  await testUrl('https://oms-api.alasasit.com/api/v1/organization/units?page=1&pageSize=100&sortField=name&sortOrder=asc');
})();
